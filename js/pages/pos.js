    ...
    <div class="pos-wrap">
      ...
      <div class="pos-right" id="pos-cart-panel">
        ...
        <div class="pos-totals-block">
          ...
          <div class="totals-row"><span>Remise</span><input id="pos-discount" type="number" class="disc-input" value="0" min="0" oninput="refreshTotals()" ${!Auth.can('pos_discount') ? 'disabled title="Autorisation requise"' : ''}></div>
...
async function _validerVenteLogic() {
  ...
  if (disc > 0 && !Auth.can('pos_discount') && DB.AppState.currentUser?.role !== 'admin') {
  ...
  if (method === 'credit') {
    ...
    if (window.Auth && !Auth.can('pos_pay_credit') && DB.AppState.currentUser?.role !== 'admin') {
